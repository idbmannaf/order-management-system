    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-widget">
                ...
                <div class="card-body">
                    {{-- {{route('admin.roleEditPost',['type'=>$type, 'role'=> $admin])}} --}}
                    <form class="" method="post"
                        action="{{ route('depo.roleEditPost', ['type' => $type, 'role' => $admin]) }}">
                        {{ csrf_field() }}
                        ...
                        @if ($type == 'dealer')
                            ...
                            <div class="form-group has-feedback{{ $errors->has('gm') ? ' has-error' : '' }}">
                                ...
                                <select class="form-control select2" name="gm" id="gm">
                                    ...
                                    @foreach ($depos as $gm)
                                        <option {{ $admin->depo_id == $gm->id ? 'selected':null }} value="{{ $gm->id }}">{{ $gm->name }} </option>
                                    @endforeach
                                </select>
                            </div>
                        @elseif($type == 'agent')
                            ...
                            <div class=" form-group has-feedback{{ $errors->has('dealer') ? ' has-error' : '' }}">
                                ...
                                <select style="width:100%;" class="form-control select2" name="dealer" id="dealer">
                                    <option value="{{ $admin->dealer_id }}">{{ $admin->dealer->title }}
