...
<tr>
    ...
    <td>
        <a class="btn btn-primary btn-sm " href="{{ route('depo.ecommerce.orderDetails',['depo'=>$depo,'order'=> $order->id]) }}">manage</a>
    </td>
...
@else
    <tr>
        <td colspan="15" class="text-danger text-center h3">No result found.</td>
    </tr>
@endif
