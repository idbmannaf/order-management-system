      ...
      <div class="row">
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-info">
            ...
            <a href="{{ route('depo.allOrders',$depo) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box w3-orange">
            ...
            <a href="{{ route('depo.collections',['depo'=>$depo,'type'=>'all']) }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
...
<script>
  $(function () {
     ...
     */
     ...
     axios.get(window.location.origin+'/gm/dashboard/chart-data/get/').then(res => {
