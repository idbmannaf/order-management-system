  ...
  <nav class="main-header navbar navbar-expand navbar-indigo navbar-dark border-bottom-0" >
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="" class="nav-link text-white">Distributor: {{ $distributor->name }}</a>
      </li>

      <li class="nav-item d-none d-sm-inline-block">
        <a href="" class="nav-link text-white">Balance: {{ env('CURRENCY_SYMBLE') }} {{ number_format($distributor->balance,2) }}</a>
      </li>
      {{-- <li class="nav-item d-none d-sm-inline-block">
