                    ...
                    <tbody>
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                {{-- <td><a href="" onclick="print()">Print</a></td> --}}
                                <td>
                                    <div class="btn-group btn-sm">
                                        <a class="btn btn-info btn-xs" href="{{ route('factory.orders.ordersShippedPrint',['order'=>$order->id]) }}">Invoice</a>
                                        <a class="btn btn-success btn-xs" href="{{ route('factory.orders.downloadOrdersShipped',['order'=>$order->id,'type'=>'shipped']) }}">Download</a>
                                    </div>
