                ...
                <div class="card-header with-border">
                    <h3 class="card-title"><i class="fa fa-th"></i> All @if ($type == 'depo')
                        ...
                        @elseif($type == 'dealer')
                            SMO
                        @elseif($type == 'agent')
                            SR &nbsp; <span data-href="{{route('file-export',['type'=>'sr'])}}" id="export" class="btn btn-info btn-sm float-right" onclick="exportTasks(event.target);"> <i class="fas fa-download"></i> Export</span>
                        @else
                ...
                <div class="modal-body">
                    <div class="card card-widget">
                        ...
                        <form class="" method="post"
                            action="{{ route('admin.roleAddNewPost', $type) }}">
                            {{ csrf_field() }}
                            <div class="card-body">
