...
<div class="card">
        ...
        <div class="row">
            ...
            <div class="col-md-5 float-right">
                <div class="input-group mb-2">
                  ...
                  <input type="hidden" name="url" id="url" value="{{ route('admin.search', ['shop']) }}">
    ...
    <div class="card-body">
        <span data-href="{{route('file-export',['type'=>'shop','status'=>'all'])}}" id="export" class="btn btn-success btn-sm float-right" onclick="exportTasks(event.target);"> <i class="fas fa-download"></i> Export</span>
        ...
        <div class="table-responsive" style="min-height: 75vh;">
            <table class="table table-bordered table-sm table-striped">
                ...
                <tbody id="tableBody">
                    @include('admin.ecommerce.shop.parts.shopsTableBody')
                </tbody>
            </table>
        </div>
