...
class CreateProductReplacementItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_replacement_items', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('product_replacement_id')->unsigned()->nullable();
            $table->bigInteger('shipment_return_id')->unsigned()->nullable();
            $table->bigInteger('shipment_return_item_id')->unsigned()->nullable();
            ...
            $table->decimal('replace_quantity',10,2)->default(0);
            ...
            $table->decimal('replace_amount',15,2)->default(0); //p * q
